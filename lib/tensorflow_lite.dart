...
class Interpreter {
  ...
  Future<dynamic> runAsFloat32A(Float32List inputBytes, ByteBuffer outputBytes) async {
    return _channel.invokeMethod("Interpreter.run", [inputBytes, outputBytes]);
  }
  
  Future<dynamic> runAsFloat32B(Float32List inputBytes, Uint8List outputBytes) async {
    return _channel.invokeMethod("Interpreter.run", [inputBytes, outputBytes]);
  }
